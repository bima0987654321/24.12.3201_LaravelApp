        ...
        <form action="{{ route('admin.events.store') }}" method="POST"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title"
                    class="w-full border border-gray-300 p-2.5 rounded focus:ring focus:ringindigo-200" required>
            </div>

            <div class="mb-4">
                <label class="block mb-2 font-medium text-gray700">Kategori Event</label>
                <select name="category_id"
                    class="w-full border border-gray-300 p-2.5 rounded focus:ring focus:ring-indigo200" required>
