...
border-gray-300 p-2.5 rounded" rows="3" required>{{ $event->description }}</textarea>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb4">
                ...
                <div>
                    ...
                    <input type="number" name="price" value="{{ $event->price }}"
                        class="w-full border border-gray-300 p-2.5
rounded" required>
                </div>
                <div>
...
rounded" required>
            ...
            <div class="flex justify-end border-t pt-4">
                <button type="submit"
                    class="bg-blue-600 textwhite px-8 py-2.5 rounded font-semibold hover:bg-blue-700
shadow-md">Simpan
                    Perubahan</button>
            </div>
        </form>
